...
import { Loader2, Image as ImageIcon, Brain } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-red-100 relative">
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800">上传的图片</h2>
        </div>
        <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-red-50 to-green-50 shadow-inner">
          <img
            src={imageUrl}
            alt="待分析图片"
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800">文字分析结果</h2>
        </div>
        <div className="bg-gradient-to-br from-red-50 to-green-50 rounded-xl p-6 flex-1 shadow-inner">
          {analysis.isLoading ? (
            <div className="flex items-center justify-center h-full">
              <div className="flex flex-col items-center gap-3">
                <Loader2 className="w-8 h-8 animate-spin text-red-600" />
                <p className="text-sm text-gray-600">正在分析图片中的文字...</p>
              </div>
            </div>
          ) : analysis.error ? (
            <div className="flex items-center justify-center h-full">
